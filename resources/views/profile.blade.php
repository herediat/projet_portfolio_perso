<nav class="navbar navbar-expand-lg fixed-top">
     <div class="container">
         ...
         <a class="navbar-brand" href="index.html">Tshishimbi Heredia</a>
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
             <ul class="navbar-nav ml-lg-auto">
                 <li class="nav-item">
                     <a href="#home" class="nav-link smoothScroll">Profile</a>
                 </li>
                 ...
                 <li class="nav-item">
                     <a href="#class" class="nav-link smoothScroll">Skills</a>
                 </li>
 
                 <li class="nav-item">
                     <a href="#schedule" class="nav-link smoothScroll">Projects</a>
                 </li>
